...
import com.project.thenewsapp.adapters.NewsAdapter
import com.project.thenewsapp.ui.NewsActivity
import com.project.thenewsapp.ui.NewsViewModel
import com.project.thenewsapp.util.Constants
import com.project.thenewsapp.util.Constants.Companion.SEARCH_NEWS_TIME_DELAY
import com.project.thenewsapp.util.Resource
...
class SearchFragment : Fragment(R.layout.fragment_search) {
    ...
    val scrollListener = object : RecyclerView.OnScrollListener() {
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            val shouldPaginate =
                isNoErrors && isNotLoadingAndNotLastPage && isAlLastItem && isNotAtBeginning && isTotalMoreThanVisible && isScrolling
            if (shouldPaginate) {
                newsViewModel.searchNews(binding.searchEdit.text.toString())
                isScrolling = false
            }
